...
<body class="min-h-screen flex items-center justify-center py-8">
    <div class="max-w-md w-full mx-4">
        <div class="text-center mb-8">
            <img src="<?php echo e(asset('images/logo-ifrs.png')); ?>" alt="Logo IFRS" class="h-20 mx-auto mb-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    Já tem uma conta? 
                    <a href="<?php echo e(route('login')); ?>" class="text-[#41a24d] hover:text-green-700 font-semibold">
                        Entrar aqui
                    </a>
                </p>
            </div>
