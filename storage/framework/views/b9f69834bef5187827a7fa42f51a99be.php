...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        ...
        <div class="mt-6 text-center">
            ...
            <a href="<?php echo e(route('cadastro')); ?>" class="text-green-600 hover:text-green-800 font-semibold">
                Cadastre-se aqui
            </a>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\tcc-mauro\resources\views/autenticacao/login.blade.php ENDPATH**/ ?>