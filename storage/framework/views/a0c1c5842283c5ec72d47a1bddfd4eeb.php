...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('professor.painel')); ?>" 
            ...
            <!-- Gerenciar Conteúdos -->
            <a href="<?php echo e(route('professor.conteudos.index')); ?>" 
               class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition transform hover:scale-105">
                <div class="flex items-center justify-between mb-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-bold text-2xl" style="color: #41a24d;"><?php echo e($totalQuestionarios ?? 0); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">Questionários Ativos:</span>
                        <span class="font-bold text-2xl" style="color: #41a24d;"><?php echo e($questionariosAtivos ?? 0); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <a href="<?php echo e(route('professor.questionarios.create')); ?>" 
                ...
                <a href="<?php echo e(route('professor.conteudos.create')); ?>" 
                   class="text-white px-6 py-4 rounded-lg font-semibold text-center"
                   style="background-color: #41a24d;"
                   onmouseover="this.style.backgroundColor='#358a3f'"
                   onmouseout="this.style.backgroundColor='#41a24d'">
...
</html><?php /**PATH C:\Users\Mauro Rosa\Desktop\tcc-mauro\resources\views/professor/painel.blade.php ENDPATH**/ ?>