...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        <div class="text-center mb-8">
            <img src="{{ asset('images/logo-ifrs.png') }}" 
                 alt="IFRS Logo" 
        ...
        <div class="mt-6 text-center">
            ...
            <a href="{{ route('cadastro') }}" class="font-semibold" style="color: #41a24d;">
                Cadastre-se aqui
            </a>
        </div>
    </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-gray-600">Ainda não tem conta?</p>
            <a href="{{ route('cadastro') }}" class="text-green-600 hover:text-green-800 font-semibold">
                Cadastre-se aqui
            </a>
        </div>

        <!-- Botão Google (será implementado depois) -->
        <div class="mt-4">
            <button class="w-full bg-white border border-gray-300 text-gray-700 font-semibold py-2 px-4 rounded-lg flex items-center justify-center hover:bg-gray-50 transition duration-200">
