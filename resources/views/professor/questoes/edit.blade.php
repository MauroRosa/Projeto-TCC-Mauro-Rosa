...
<body class="min-h-screen">
    <header class="bg-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Editar Questão</h1>
    ...
    <main class="max-w-4xl mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-md p-8">
            <form action="{{ route('professor.questoes.update', [$questionario->id, $questao->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <textarea 
                        ...
                        required
                    >{{ old('enunciado', $questao->enunciado) }}</textarea>
                    @error('enunciado')
                ...
                <div class="mb-6">
                    ...
                    @if($questao->imagem)
                    <div class="mb-3">
                        <img src="{{ asset('storage/' . $questao->imagem) }}" alt="Imagem atual" class="max-w-xs rounded-lg border">
                        <p class="text-sm text-gray-600 mt-2">Imagem atual. Envie uma nova para substituir.</p>
                    </div>
                    @endif
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea 
                            ...
                            required
                        >{{ old('alternativa_' . strtolower($letra), $questao->{'alternativa_' . strtolower($letra)}) }}</textarea>
                    ...
                    <div class="flex gap-4">
                        ...
                        <label class="flex items-center cursor-pointer">
                            <input 
                                ...
                                value="{{ $letra }}"
                                {{ old('resposta_correta', $questao->resposta_correta) == $letra ? 'checked' : '' }}
                ...
                <div class="mb-6">
                    ...
                    <input 
                        ...
                        value="{{ old('conteudo_linguistico', $questao->conteudo_linguistico) }}"
